let known = {
    'food': {
        ...
        'right': [
            ['food_jpg_1x_0.165.jpg', 'JPG (0.138 bpp, \u22481x ours kB)', 'JPG (8 kB, \u22481x ours kB)'],
            ['food_jpg_2x_0.312.jpg', 'JPG (0.196 bpp, \u22482x)', 'JPG (24 kB, \u22482x)'],
            ['food_jpg_3x_0.479.jpg', 'JPG (0.166 bpp, \u22483x)', 'JPG (32 kB, \u22483x)'],
            ['food_jpg_4x_0.624.jpg', 'JPG (0.156 bpp, \u22484x)', 'JPG (34 kB, \u22484x)'],
            ['DIVIDER'],
            ['food_bpg_1x_0.168.png', 'BPG (0.139 bpp, \u22481x)', 'BPG (8 kB, \u22481x)'],
            ['food_bpg_2x_0.345.png', 'BPG (0.156 bpp, \u22482x)', 'BPG (24 kB, \u22482x)'],
            ['food_bpg_3x_0.541.png', 'BPG (0.143 bpp, \u22483x)', 'BPG (99 kB, \u22483x)'],
            ['DIVIDER'],
    ...
    'women': {
        ...
        'fullres': 'https://storage.googleapis.com/hific/div2k/visualize.html?perPage=10&imgs=0848',
        'loadingRatio': '75.29411764705883%',
        'left': ['0c0ba31b279da4b8a0b848b63d302e8b_TMF.png', 'HiFiC (Ours): 0.155bpp', 'HiFiC (Ours): 61 kB'],
        'right': [
            ...
            ['0c0ba31b279da4b8a0b848b63d302e8b_jpg15.png', 'JPG (0.317 bpp, \u22483x)', 'JPG (1.20 MB, \u22483x)'],
            ['DIVIDER'],
            ['0c0ba31b279da4b8a0b848b63d302e8b_bpg48.png', 'BPG (0.139 bpp, \u22481x)', 'BPG (539 kB, \u22481x)'],
            ['0c0ba31b279da4b8a0b848b63d302e8b_bpg43.png', 'BPG (0.205 bpp, \u22482x)', 'BPG (796 kB, \u22482x)'],
            ['0c0ba31b279da4b8a0b848b63d302e8b_bpg42.png', 'BPG (0.289 bpp, \u22483x)', 'BPG (1.10 MB, \u22483x)'],
            ['DIVIDER'],
            ['0c0ba31b279da4b8a0b848b63d302e8b_hific_l_0.097bpp.png', 'HiFiC (0.097 bpp, \u22481x)', 'HiFiC (376 kB, \u22481x)'],
            ...
            ['DIVIDER'],
            ['0c0ba31b279da4b8a0b848b63d302e8b_0text.png', 'Without Text', 'Without Text'],
            ['DIVIDER'],
    ...
    'road': {
        ...
        'right': [
            ...
            ['DIVIDER'],
            ['0cb87ff168cf338fee6161e5e1892211_0text.png', 'Without Text', 'Without Text'],
            ['DIVIDER'],
    ...
    'kodim15': {
        ...
        'right': [
            ...
            ['DIVIDER'],
            ['kodim15_0text.png', 'Without Text', 'Without Text'],
            ['DIVIDER'],
